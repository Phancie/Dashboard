 ...
 * @author REUBEN
 */
public class WeekDayActivity extends javax.swing.JFrame {

    /**
     * Creates new form WeekDayActivity
     */
    ArrayList<CloudModelClass> weekdayDetails = new ArrayList<>();
    DatabaseReference refchild;
    final static int NO_OF_COLUMNS = 33;
    
    public WeekDayActivity() {
        initComponents();
        super.setTitle("AeD Money Lending Dashboard [Week Day Due Loans]");
                             ...
                             refchild.orderByChild("status").equalTo("Disbursed").addChildEventListener(new ChildEventListener() {
                                 ...
                                 public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
                                     ...
                                     //CHECKING DATE HERE
                                        ...
                                        String weekday_today = sdf.format(resultdate);
                                        if(cmc.getdue_date().equals(weekday_today)){
                                            weekdayDetails.add(cmc);
                                            addRowToTable();
                                        }
    ...
    public void addRowToTable(){
            ...
            DefaultTableModel model = (DefaultTableModel) weekdayCustDetailsTable.getModel();
            Object rowData[] = new Object[NO_OF_COLUMNS];
            
            System.out.println("Table arraylist size "+weekdayDetails.size());
            for(int x =0; x<weekdayDetails.size();x++)
            {
                
                rowData[0]= x+1;
                rowData[1]= weekdayDetails.get(x).getFname();
                rowData[2]= weekdayDetails.get(x).getMname();
                rowData[3]= weekdayDetails.get(x).getLname();
                rowData[4]= weekdayDetails.get(x).getPhone();
                rowData[5]= weekdayDetails.get(x).getEmail();
                rowData[6]= weekdayDetails.get(x).getAmount();
                rowData[7]= weekdayDetails.get(x).getActual_amount();
                rowData[8]= weekdayDetails.get(x).getDays();
                rowData[9]= weekdayDetails.get(x).getAlternate_Phone_Number();
                rowData[10]= weekdayDetails.get(x).getGender();
                rowData[11]= weekdayDetails.get(x).getDate_Of_Birth();
                rowData[12]= weekdayDetails.get(x).getId_Type();
                rowData[13]= weekdayDetails.get(x).getId_Number();
                rowData[14]= weekdayDetails.get(x).getLocation();
                rowData[15]= weekdayDetails.get(x).getPost_Address();
                rowData[16]= weekdayDetails.get(x).getLength_of_Res();
                rowData[17]= weekdayDetails.get(x).getMari_stat();
                rowData[18]= weekdayDetails.get(x).getCompany_Name();
                rowData[19]= weekdayDetails.get(x).getJobTitle();
                rowData[20]= weekdayDetails.get(x).getWrkPeriod();
                rowData[21]= weekdayDetails.get(x).getSalary();
                rowData[22]= weekdayDetails.get(x).getLoan_Purpose();
                rowData[23]= weekdayDetails.get(x).getBank();
                rowData[24]= weekdayDetails.get(x).getAccount_Name();
                rowData[25]= weekdayDetails.get(x).getAccount_Number();
                rowData[26]= weekdayDetails.get(x).getBankBranch();
                rowData[27]= weekdayDetails.get(x).getGuarantor_Full_Name();
                rowData[28]= weekdayDetails.get(x).getGuarantor_Date_Of_Birth();
                rowData[29]= weekdayDetails.get(x).getGuarantor_Phone_Number();
                rowData[30]= weekdayDetails.get(x).getdue_date();
                rowData[31]= weekdayDetails.get(x).getstatus();
                rowData[32]= weekdayDetails.get(x).getToken();
    ...
    private void setComboCol() {
        TableColumn comboboxColumn = weekdayCustDetailsTable.getColumnModel().getColumn(31);
    ...
    public void addSearchRowToTable(){
            ...
            if (weekdayCustDetailsTable.getRowCount() > 0) {
                for (int i = weekdayCustDetailsTable.getRowCount() - 1; i > -1; i--) {
                    model.removeRow(i);
                }
            }
    ...
    private void initComponents() {
        ...
        weekdayCustDetailsTable = new javax.swing.JTable();
        ...
        weekdayCustDetailsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        weekdayCustDetailsTable.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        weekdayCustDetailsTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        weekdayCustDetailsTable.setShowHorizontalLines(false);
        weekdayCustDetailsTable.setShowVerticalLines(false);
        jScrollPane1.setViewportView(weekdayCustDetailsTable);
        if (weekdayCustDetailsTable.getColumnModel().getColumnCount() > 0) {
            weekdayCustDetailsTable.getColumnModel().getColumn(1).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(1).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(2).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(2).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(3).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(3).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(4).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(4).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(5).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(5).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(6).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(6).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(7).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(7).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(8).setMinWidth(120);
            weekdayCustDetailsTable.getColumnModel().getColumn(8).setPreferredWidth(120);
            weekdayCustDetailsTable.getColumnModel().getColumn(9).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(9).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(10).setMinWidth(120);
            weekdayCustDetailsTable.getColumnModel().getColumn(10).setPreferredWidth(120);
            weekdayCustDetailsTable.getColumnModel().getColumn(11).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(11).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(12).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(12).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(13).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(13).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(14).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(14).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(15).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(15).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(16).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(16).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(17).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(17).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(18).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(18).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(19).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(19).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(20).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(20).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(21).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(21).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(22).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(22).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(23).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(23).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(24).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(24).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(25).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(25).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(26).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(26).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(27).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(27).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(28).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(28).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(29).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(29).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(30).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(30).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(31).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(31).setPreferredWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(32).setMinWidth(150);
            weekdayCustDetailsTable.getColumnModel().getColumn(32).setPreferredWidth(150);
        }
                    ...
                    for (DataSnapshot childSnapshot: snapshot.getChildren()) {
                        ...
                        searchRefChild.orderByChild("status").equalTo("Disbursed").addChildEventListener(new ChildEventListener() {
                            ...
                            public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
                                ...
                                if(cmc.getFname().equals(searchFld.getText().trim()) && cmc.getdue_date().equals(weekday_today)){
                                    weekdayDetails.add(cmc);
                                    addSearchRowToTable();
                    ...
                    for (DataSnapshot childSnapshot: snapshot.getChildren()) {
                        ...
                        searchRefChild.orderByChild("status").equalTo("Disbursed").addChildEventListener(new ChildEventListener() {
                            ...
                            public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
                                ...
                                //FILTERING FOR SEARCHED VAL
                                if(cmc.getLname().equals(searchFld.getText().trim()) && cmc.getdue_date().equals(weekday_today)){
                                    weekdayDetails.add(cmc);
                                    addSearchRowToTable();
                                    resultLbl.setText("Showing results for: "+searchFld.getText());
                                    searchFld.setText("");
                    ...
                    for (DataSnapshot childSnapshot: snapshot.getChildren()) {
                        ...
                        searchRefChild.orderByChild("status").equalTo("Disbursed").addChildEventListener(new ChildEventListener() {
                            ...
                            public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
                                ...
                                //FILTERING FOR SEARCHED VAL
                                if(cmc.getId_Number().equals(searchFld.getText().trim()) && cmc.getdue_date().equals(weekday_today)){
                                    weekdayDetails.add(cmc);
                                    addSearchRowToTable();
                                    resultLbl.setText("Showing results for: "+searchFld.getText());
                                    searchFld.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WeekDayActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WeekDayActivity().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable weekdayCustDetailsTable;
