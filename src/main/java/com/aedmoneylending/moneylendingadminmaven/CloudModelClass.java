...
public class CloudModelClass {
    ...
    public CloudModelClass( String fname, String mname, String lname, String phone, String email,
                            ...
                            String guarantor_Date_Of_Birth, String guarantor_Phone_Number,
                            String token,String status,String due_date,String first_timer) {
        this.fname = fname;
        this.mname = mname;
        this.lname = lname;
        this.phone = phone;
