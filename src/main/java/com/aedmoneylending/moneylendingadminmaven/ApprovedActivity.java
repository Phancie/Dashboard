 ...
 * @author REUBEN
 */
public class ApprovedActivity extends javax.swing.JFrame implements TableModelListener {

    /**
     * Creates new form ApprovedActivity
     */
    
    ArrayList<CloudModelClass> approvedUserDetails = new ArrayList<>();
    ...
    public ApprovedActivity() {
        initComponents();
        super.setTitle("AeD Money Lending Dashboard [Approved Loans]");
    ...
    private void initComponents() {
        ...
        approvedCustDetailsTable = new javax.swing.JTable();
        ...
        approvedCustDetailsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        approvedCustDetailsTable.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        approvedCustDetailsTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        approvedCustDetailsTable.setShowHorizontalLines(false);
        approvedCustDetailsTable.setShowVerticalLines(false);
        jScrollPane1.setViewportView(approvedCustDetailsTable);
        if (approvedCustDetailsTable.getColumnModel().getColumnCount() > 0) {
            approvedCustDetailsTable.getColumnModel().getColumn(1).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(1).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(2).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(2).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(3).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(3).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(4).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(4).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(5).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(5).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(6).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(6).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(7).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(7).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(8).setMinWidth(120);
            approvedCustDetailsTable.getColumnModel().getColumn(8).setPreferredWidth(120);
            approvedCustDetailsTable.getColumnModel().getColumn(9).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(9).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(10).setMinWidth(120);
            approvedCustDetailsTable.getColumnModel().getColumn(10).setPreferredWidth(120);
            approvedCustDetailsTable.getColumnModel().getColumn(11).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(11).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(12).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(12).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(13).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(13).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(14).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(14).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(15).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(15).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(16).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(16).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(17).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(17).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(18).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(18).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(19).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(19).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(20).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(20).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(21).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(21).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(22).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(22).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(23).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(23).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(24).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(24).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(25).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(25).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(26).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(26).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(27).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(27).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(28).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(28).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(29).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(29).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(30).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(30).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(31).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(31).setPreferredWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(32).setMinWidth(150);
            approvedCustDetailsTable.getColumnModel().getColumn(32).setPreferredWidth(150);
        }
                ...
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                         for (DataSnapshot childSnapshot: snapshot.getChildren()){
                             ...
                             refchild.orderByChild("status").equalTo("Approved").addChildEventListener(new ChildEventListener() {

                                 @Override
                                 public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
                                     CloudModelClass cmc = snapshot.getValue(CloudModelClass.class);
                                     approvedUserDetails.add(cmc);
                                     addRowToTable();
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        if(searchCriteriaCbx.getSelectedIndex()==0){
            ...
            searchRef.orderByChild("status").equalTo("Approved").addChildEventListener(new ChildEventListener() {
            ...
            searchRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    for (DataSnapshot childSnapshot: snapshot.getChildren()) {
                        ...
                        searchRefChild.orderByChild("status").equalTo("Approved").addChildEventListener(new ChildEventListener() {
    ...
    public void addRowToTable(){
            ...
            DefaultTableModel model = (DefaultTableModel) approvedCustDetailsTable.getModel();
            Object rowData[] = new Object[NO_OF_COLUMNS];
            
            System.out.println("Table arraylist size "+approvedUserDetails.size());
            for(int x =0; x<approvedUserDetails.size();x++)
            {
                
                rowData[0]= x+1;
                rowData[1]= approvedUserDetails.get(x).getFname();
                rowData[2]= approvedUserDetails.get(x).getMname();
                rowData[3]= approvedUserDetails.get(x).getLname();
                rowData[4]= approvedUserDetails.get(x).getPhone();
                rowData[5]= approvedUserDetails.get(x).getEmail();
                rowData[6]= approvedUserDetails.get(x).getAmount();
                rowData[7]= approvedUserDetails.get(x).getActual_amount();
                rowData[8]= approvedUserDetails.get(x).getDays();
                rowData[9]= approvedUserDetails.get(x).getAlternate_Phone_Number();
                rowData[10]= approvedUserDetails.get(x).getGender();
                rowData[11]= approvedUserDetails.get(x).getDate_Of_Birth();
                rowData[12]= approvedUserDetails.get(x).getId_Type();
                rowData[13]= approvedUserDetails.get(x).getId_Number();
                rowData[14]= approvedUserDetails.get(x).getLocation();
                rowData[15]= approvedUserDetails.get(x).getPost_Address();
                rowData[16]= approvedUserDetails.get(x).getLength_of_Res();
                rowData[17]= approvedUserDetails.get(x).getMari_stat();
                rowData[18]= approvedUserDetails.get(x).getCompany_Name();
                rowData[19]= approvedUserDetails.get(x).getJobTitle();
                rowData[20]= approvedUserDetails.get(x).getWrkPeriod();
                rowData[21]= approvedUserDetails.get(x).getSalary();
                rowData[22]= approvedUserDetails.get(x).getLoan_Purpose();
                rowData[23]= approvedUserDetails.get(x).getBank();
                rowData[24]= approvedUserDetails.get(x).getAccount_Name();
                rowData[25]= approvedUserDetails.get(x).getAccount_Number();
                rowData[26]= approvedUserDetails.get(x).getBankBranch();
                rowData[27]= approvedUserDetails.get(x).getGuarantor_Full_Name();
                rowData[28]= approvedUserDetails.get(x).getGuarantor_Date_Of_Birth();
                rowData[29]= approvedUserDetails.get(x).getGuarantor_Phone_Number();
                rowData[30]= approvedUserDetails.get(x).getdue_date();
                rowData[31]= approvedUserDetails.get(x).getstatus();
                rowData[32]= approvedUserDetails.get(x).getToken();
    ...
    private void setComboCol() {
        TableColumn comboboxColumn = approvedCustDetailsTable.getColumnModel().getColumn(31);
    ...
    public void addSearchRowToTable(){
            ...
            if (approvedCustDetailsTable.getRowCount() > 0) {
                for (int i = approvedCustDetailsTable.getRowCount() - 1; i > -1; i--) {
                    model.removeRow(i);
                }
            }
                    ...
                    public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
                        ...
                        //UPDATING FIELDS
                         if(val.equals("Disbursed") || val.equals("Outstanding")){
                            ...
                            approvedCustDetailsTable.setValueAt(dateObj, row, col);
                        }
                        if(val.equals("Pending") || val.equals("Withdrawn") || val.equals("Approved") || val.equals("Denied")){
                            ...
                            approvedCustDetailsTable.setValueAt("Unspecificied", row, col);
                        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApprovedActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApprovedActivity().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable approvedCustDetailsTable;
