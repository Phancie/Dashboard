 ...
 * @author REUBEN
 */
public class DisbursedActivity extends javax.swing.JFrame {

    /**
     * Creates new form DisbursedActivity
     */
    ArrayList<CloudModelClass> disbursedUserDetails = new ArrayList<>();
    DatabaseReference refchild;
    final static int NO_OF_COLUMNS = 33;
    
    public DisbursedActivity() {
        initComponents();
        super.setTitle("AeD Money Lending Dashboard [Disbursed Loans]");
    ...
    public void addRowToTable(){
            ...
            DefaultTableModel model = (DefaultTableModel) disbursedCustDetailsTable.getModel();
            Object rowData[] = new Object[NO_OF_COLUMNS];
            
            System.out.println("Table arraylist size "+disbursedUserDetails.size());
            for(int x =0; x<disbursedUserDetails.size();x++)
            {
                
                rowData[0]= x+1;
                rowData[1]= disbursedUserDetails.get(x).getFname();
                rowData[2]= disbursedUserDetails.get(x).getMname();
                rowData[3]= disbursedUserDetails.get(x).getLname();
                rowData[4]= disbursedUserDetails.get(x).getPhone();
                rowData[5]= disbursedUserDetails.get(x).getEmail();
                rowData[6]= disbursedUserDetails.get(x).getAmount();
                rowData[7]= disbursedUserDetails.get(x).getActual_amount();
                rowData[8]= disbursedUserDetails.get(x).getDays();
                rowData[9]= disbursedUserDetails.get(x).getAlternate_Phone_Number();
                rowData[10]= disbursedUserDetails.get(x).getGender();
                rowData[11]= disbursedUserDetails.get(x).getDate_Of_Birth();
                rowData[12]= disbursedUserDetails.get(x).getId_Type();
                rowData[13]= disbursedUserDetails.get(x).getId_Number();
                rowData[14]= disbursedUserDetails.get(x).getLocation();
                rowData[15]= disbursedUserDetails.get(x).getPost_Address();
                rowData[16]= disbursedUserDetails.get(x).getLength_of_Res();
                rowData[17]= disbursedUserDetails.get(x).getMari_stat();
                rowData[18]= disbursedUserDetails.get(x).getCompany_Name();
                rowData[19]= disbursedUserDetails.get(x).getJobTitle();
                rowData[20]= disbursedUserDetails.get(x).getWrkPeriod();
                rowData[21]= disbursedUserDetails.get(x).getSalary();
                rowData[22]= disbursedUserDetails.get(x).getLoan_Purpose();
                rowData[23]= disbursedUserDetails.get(x).getBank();
                rowData[24]= disbursedUserDetails.get(x).getAccount_Name();
                rowData[25]= disbursedUserDetails.get(x).getAccount_Number();
                rowData[26]= disbursedUserDetails.get(x).getBankBranch();
                rowData[27]= disbursedUserDetails.get(x).getGuarantor_Full_Name();
                rowData[28]= disbursedUserDetails.get(x).getGuarantor_Date_Of_Birth();
                rowData[29]= disbursedUserDetails.get(x).getGuarantor_Phone_Number();
                rowData[30]= disbursedUserDetails.get(x).getdue_date();
                rowData[31]= disbursedUserDetails.get(x).getstatus();
                rowData[32]= disbursedUserDetails.get(x).getToken();
    ...
    private void setComboCol() {
        TableColumn comboboxColumn = disbursedCustDetailsTable.getColumnModel().getColumn(31);
    ...
    public void addSearchRowToTable(){
            ...
            if (disbursedCustDetailsTable.getRowCount() > 0) {
                for (int i = disbursedCustDetailsTable.getRowCount() - 1; i > -1; i--) {
                    model.removeRow(i);
                }
            }
    ...
    private void initComponents() {
        ...
        disbursedCustDetailsTable = new javax.swing.JTable();
        ...
        disbursedCustDetailsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        disbursedCustDetailsTable.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        disbursedCustDetailsTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        disbursedCustDetailsTable.setShowHorizontalLines(false);
        disbursedCustDetailsTable.setShowVerticalLines(false);
        jScrollPane1.setViewportView(disbursedCustDetailsTable);
        if (disbursedCustDetailsTable.getColumnModel().getColumnCount() > 0) {
            disbursedCustDetailsTable.getColumnModel().getColumn(0).setResizable(false);
            disbursedCustDetailsTable.getColumnModel().getColumn(1).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(1).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(2).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(2).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(3).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(3).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(4).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(4).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(5).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(5).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(6).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(6).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(7).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(7).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(8).setMinWidth(120);
            disbursedCustDetailsTable.getColumnModel().getColumn(8).setPreferredWidth(120);
            disbursedCustDetailsTable.getColumnModel().getColumn(9).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(9).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(10).setMinWidth(120);
            disbursedCustDetailsTable.getColumnModel().getColumn(10).setPreferredWidth(120);
            disbursedCustDetailsTable.getColumnModel().getColumn(11).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(11).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(12).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(12).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(13).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(13).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(14).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(14).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(15).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(15).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(16).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(16).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(17).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(17).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(18).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(18).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(19).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(19).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(20).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(20).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(21).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(21).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(22).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(22).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(23).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(23).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(24).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(24).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(25).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(25).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(26).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(26).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(27).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(27).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(28).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(28).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(29).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(29).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(30).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(30).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(31).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(31).setPreferredWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(32).setMinWidth(150);
            disbursedCustDetailsTable.getColumnModel().getColumn(32).setPreferredWidth(150);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisbursedActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisbursedActivity().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable disbursedCustDetailsTable;
