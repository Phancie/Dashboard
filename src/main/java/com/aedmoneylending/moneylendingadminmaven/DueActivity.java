 ...
 * @author REUBEN
 */
public class DueActivity extends javax.swing.JFrame {

    /**
     * Creates new form DueActivity
     */
    ArrayList<CloudModelClass> dueUserDetails = new ArrayList<>();
    DatabaseReference refchild;
    final static int NO_OF_COLUMNS = 33;
    
    public DueActivity() {
        initComponents();
        super.setTitle("AeD Money Lending Dashboard [Outstanding Loans]");
                ...
                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                         for (DataSnapshot childSnapshot: snapshot.getChildren()){
                             ...
                             refchild.orderByChild("status").equalTo("Outstanding").addChildEventListener(new ChildEventListener() {

                                 @Override
                                 public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
                                     CloudModelClass cmc = snapshot.getValue(CloudModelClass.class);
                                     dueUserDetails.add(cmc);
                                     addRowToTable();
    ...
    public void addRowToTable(){
            ...
            DefaultTableModel model = (DefaultTableModel) dueCustDetailsTable.getModel();
            Object rowData[] = new Object[NO_OF_COLUMNS];
            
            System.out.println("Table arraylist size "+dueUserDetails.size());
            for(int x =0; x<dueUserDetails.size();x++)
            {
                
                rowData[0]= x+1;
                rowData[1]= dueUserDetails.get(x).getFname();
                rowData[2]= dueUserDetails.get(x).getMname();
                rowData[3]= dueUserDetails.get(x).getLname();
                rowData[4]= dueUserDetails.get(x).getPhone();
                rowData[5]= dueUserDetails.get(x).getEmail();
                rowData[6]= dueUserDetails.get(x).getAmount();
                rowData[7]= dueUserDetails.get(x).getActual_amount();
                rowData[8]= dueUserDetails.get(x).getDays();
                rowData[9]= dueUserDetails.get(x).getAlternate_Phone_Number();
                rowData[10]= dueUserDetails.get(x).getGender();
                rowData[11]= dueUserDetails.get(x).getDate_Of_Birth();
                rowData[12]= dueUserDetails.get(x).getId_Type();
                rowData[13]= dueUserDetails.get(x).getId_Number();
                rowData[14]= dueUserDetails.get(x).getLocation();
                rowData[15]= dueUserDetails.get(x).getPost_Address();
                rowData[16]= dueUserDetails.get(x).getLength_of_Res();
                rowData[17]= dueUserDetails.get(x).getMari_stat();
                rowData[18]= dueUserDetails.get(x).getCompany_Name();
                rowData[19]= dueUserDetails.get(x).getJobTitle();
                rowData[20]= dueUserDetails.get(x).getWrkPeriod();
                rowData[21]= dueUserDetails.get(x).getSalary();
                rowData[22]= dueUserDetails.get(x).getLoan_Purpose();
                rowData[23]= dueUserDetails.get(x).getBank();
                rowData[24]= dueUserDetails.get(x).getAccount_Name();
                rowData[25]= dueUserDetails.get(x).getAccount_Number();
                rowData[26]= dueUserDetails.get(x).getBankBranch();
                rowData[27]= dueUserDetails.get(x).getGuarantor_Full_Name();
                rowData[28]= dueUserDetails.get(x).getGuarantor_Date_Of_Birth();
                rowData[29]= dueUserDetails.get(x).getGuarantor_Phone_Number();
                rowData[30]= dueUserDetails.get(x).getdue_date();
                rowData[31]= dueUserDetails.get(x).getstatus();
                rowData[32]= dueUserDetails.get(x).getToken();
    ...
    private void setComboCol() {
        TableColumn comboboxColumn = dueCustDetailsTable.getColumnModel().getColumn(31);
    ...
    public void addSearchRowToTable(){
            ...
            if (dueCustDetailsTable.getRowCount() > 0) {
                for (int i = dueCustDetailsTable.getRowCount() - 1; i > -1; i--) {
                    model.removeRow(i);
                }
            }
    ...
    private void initComponents() {
        ...
        dueCustDetailsTable = new javax.swing.JTable();
        ...
        dueCustDetailsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        dueCustDetailsTable.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        dueCustDetailsTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        dueCustDetailsTable.setShowHorizontalLines(false);
        dueCustDetailsTable.setShowVerticalLines(false);
        jScrollPane1.setViewportView(dueCustDetailsTable);
        if (dueCustDetailsTable.getColumnModel().getColumnCount() > 0) {
            dueCustDetailsTable.getColumnModel().getColumn(1).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(1).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(2).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(2).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(3).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(3).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(4).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(5).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(5).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(6).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(6).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(7).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(7).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(8).setMinWidth(120);
            dueCustDetailsTable.getColumnModel().getColumn(8).setPreferredWidth(120);
            dueCustDetailsTable.getColumnModel().getColumn(9).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(9).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(10).setMinWidth(120);
            dueCustDetailsTable.getColumnModel().getColumn(10).setPreferredWidth(120);
            dueCustDetailsTable.getColumnModel().getColumn(11).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(11).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(12).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(12).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(13).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(13).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(14).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(14).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(15).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(15).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(16).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(16).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(17).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(17).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(18).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(18).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(19).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(19).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(20).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(20).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(21).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(21).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(22).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(22).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(23).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(23).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(24).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(24).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(25).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(25).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(26).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(26).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(27).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(27).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(28).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(28).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(29).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(29).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(30).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(30).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(31).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(31).setPreferredWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(32).setMinWidth(150);
            dueCustDetailsTable.getColumnModel().getColumn(32).setPreferredWidth(150);
        }
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        if(searchCriteriaCbx.getSelectedIndex()==0){
            ...
            searchRef.orderByChild("status").equalTo("Outstanding").addChildEventListener(new ChildEventListener() {
            ...
            searchRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    for (DataSnapshot childSnapshot: snapshot.getChildren()) {
                        ...
                        searchRefChild.orderByChild("status").equalTo("Outstanding").addChildEventListener(new ChildEventListener() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DueActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DueActivity().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable dueCustDetailsTable;
